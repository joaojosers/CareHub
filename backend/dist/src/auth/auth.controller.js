...
__decorate([
    ...
    (0, swagger_1.ApiOperation)({ summary: 'Registrar novo usuário (Cuidador/Familiar)' }),
    (0, swagger_1.ApiResponse)({ status: 201, description: 'Usuário registrado com sucesso. Aguarde aprovação.' }),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Login realizado com sucesso. Retorna o token de acesso.' }),
